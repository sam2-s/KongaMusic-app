...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: moe.kongamusic.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: moe.kongamusic.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: moe.kongamusic.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is moe.kongamusic.together.JoinDecision -> {
                            ...
                            is moe.kongamusic.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
