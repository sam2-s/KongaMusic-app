...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is moe.kongamusic.together.TogetherSessionState.Joined &&
            (togetherSessionState as moe.kongamusic.together.TogetherSessionState.Joined).role is moe.kongamusic.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? moe.kongamusic.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is moe.kongamusic.together.TogetherRole.Guest
                                                                if (isGuest) {
