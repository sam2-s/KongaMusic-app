...
import moe.kongamusic.logcat.LogcatLevel
import moe.kongamusic.ui.utils.backToMain
import moe.kongamusic.viewmodels.LogcatEffect
import moe.kongamusic.viewmodels.LogcatScreenState
import moe.kongamusic.viewmodels.LogcatUiEntries
import moe.kongamusic.viewmodels.LogcatUiEntry
import moe.kongamusic.viewmodels.LogcatUiModel
import moe.kongamusic.viewmodels.LogcatViewModel
import moe.kongamusic.ui.component.FrostedHeaderPill
import moe.kongamusic.ui.component.IconButton as ArchiveTuneIconButton
...
fun LogcatScreen(
    ...
    LaunchedEffect(Unit) {
        moe.kongamusic.utils.GlobalLog.flush()
    }
            ...
            when (effect) {
                ...
                is LogcatEffect.Export -> {
                    val exportIntent =
                        Intent(Intent.ACTION_SEND).apply {
                            type = "text/plain"
                            clipData = ClipData.newRawUri("kongamusic-log.txt", effect.uri)
