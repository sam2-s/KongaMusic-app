...
import moe.kongamusic.constants.NetworkMeteredKey
...
import moe.kongamusic.constants.ProxyEnabledKey
...
import moe.kongamusic.constants.TranslateLyricsKey
    ...
    val playback =
        SettingsItem(
            ...
            children = listOf(
                ...
                SettingsChild("kongamusic Canvas", "archive_tune_canvas", listOf("canvas", "animated artwork", "motion artwork", "live artwork")) { SearchResultSwitch(ArchiveTuneCanvasKey, true) },
