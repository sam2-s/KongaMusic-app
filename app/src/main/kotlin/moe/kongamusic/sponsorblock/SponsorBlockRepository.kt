...
package moe.kongamusic.sponsorblock
...
import moe.kongamusic.constants.SponsorBlockApiUrlKey
import moe.kongamusic.constants.SponsorBlockCategoriesKey
import moe.kongamusic.constants.SponsorBlockEnabledKey
            ...
            withContext(Dispatchers.IO) {
                ...
                val response =
                    client.get("$apiUrl/api/skipSegments/$hashPrefix") {
                        ...
                        header(HttpHeaders.UserAgent, "kongamusic/${BuildConfig.VERSION_NAME}")
                    }
