...
private class GmsCastMediaItemConverter(
    ...
    private fun MediaItem.enrichWithAppMetadata(mediaQueueItem: MediaQueueItem): MediaItem {
        ...
        val appMetadata = (localConfiguration?.tag as? moe.kongamusic.models.MediaMetadata)
    ...
    private fun MediaInfo?.toAppMediaMetadata(mediaId: String): moe.kongamusic.models.MediaMetadata {
        val castMetadata = this?.metadata
        val title = castMetadata?.stringValue(CastMetadata.KEY_TITLE) ?: mediaId
        val artistText =
        ...
        return moe.kongamusic.models.MediaMetadata(
            ...
            album =
                albumTitle?.let {
                    moe.kongamusic.models.MediaMetadata.Album(
                        id = it,
                        title = it,
                    )
                },
    ...
    private fun openResolvedRemoteSource(
        ...
        val connection =
            (URL(resolvedUri.toString()).openConnection() as HttpURLConnection).apply {
                ...
                setRequestProperty("User-Agent", "kongamusic Cast")
