...
import moe.kongamusic.lastfm.models.LastFmError
import moe.kongamusic.lastfm.models.RecentTracksResponse
...
import moe.kongamusic.lastfm.models.TrackInfoResponse
import moe.kongamusic.lastfm.models.TokenResponse
import moe.kongamusic.lastfm.models.UserInfoResponse
import java.net.URI
...
object LastFM {
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "kongamusic (https://github.com/4nx3b/ArchiveTune)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
